...
<br>
<br>
A radial bar chart is essentially a bar chart plotted on a **polar coordinates system**, rather than on a Cartesian one. In our case, the grpah is a **stacked** radial bar chart. 
:::
...
## `r fa("r-project", fill = "#0008C1")`: STEP-BY-STEP GRAPH RECREATION
...
### STEP 1: Create a basic bar plot for "group1"
...
Next a custom color palettes can be specified using the `scale_color_manual` function:
...
### STEP 5: Switch to the polar coordinate system
...
### STEP 7: Add country labels and adjust the legend of the graph
...
#| label: fig-fig7
#| fig-cap: fig7
#| source-line-numbers: "8,9,11-15,25-28"
...
### STEP 8: Apply final theme adjustments to the graph 
...
#| label: fig-fig8
#| fig-cap: fig8
#| source-line-numbers: "30-33,36-39"
