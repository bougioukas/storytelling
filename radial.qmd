...
The original chart #79 (click on the figure to be redirected to the source).
<br>
<br>
A radial bar chart is essentially a bar chart plotted on a **polar coordinates system**, rather than on a Cartesian one. In our case, the data visualization is a **stacked** radial bar chart. 
:::
