...
[![The original graph obtained from Our World in Data ](img/cocoa-beans-production-by-region.png)](https://ourworldindata.org/grapher/cocoa-beans-production-by-region)
...
p <- ggplot(dat_cocoa, aes(x = year, y = cocoa_beans, fill = region_rev)) +
  ...
  labs(title = "Cocoa bean production by region, 1961 to 2021",
       ...
       x = "Year",
       y = "Cocoa Beans") +
  theme(plot.margin = margin(5, 110, 45, 14),
    ...
    plot.caption = element_markdown(
      color = "grey30",
      size = 21, hjust = -0.31, margin = margin(t = 30)),
...
p + geom_text(size = 7, hjust = 0,
  ...
  geom_text(aes(x = Inf, y = -Inf, label = "OurWorldInData.org/agricultural-production | CC BY"), 
            size = 7.2, hjust = 0.9, vjust = 7.5, color = "grey30")
```
